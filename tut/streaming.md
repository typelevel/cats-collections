...
scala> zs.toList
res0: dogs.List[Int] = List(1, 10, 3, 21, 201, 2001)
```
...
scala> ns.toString(3)
res1: dogs.Predef.String = Streaming(1, 2, 3, ...)

scala> ns.toString(5)
res2: dogs.Predef.String = Streaming(1, 2, 3, 4, 5, ...)

scala> ns.toString(100)
res3: dogs.Predef.String = Streaming(1, 2, 3, 4, 5)
```
...
int: (n: dogs.Predef.Int)dogs.Predef.Int

scala> val now = Streaming(int(1), int(2), int(3))
int(1)
int(2)
int(3)
now: dogs.Streaming[dogs.Predef.Int] = Streaming(1, ...)

scala> val later = int(1) %:: int(2) %:: int(3) %:: Streaming.empty[Int]
int(1)
later: dogs.Streaming[dogs.Predef.Int] = Streaming(1, ...)
```
...
fives: dogs.Streaming[dogs.Predef.Int] = <lazy>

scala> fives.take(5).toList
res4: dogs.List[dogs.Predef.Int] = List(5, 5, 5, 5, 5)
```
...
res9: dogs.Predef.String = Streaming((1,1), (1,2), (2,1), (1,3), (2,2), (3,1), (1,4), (2,3), (3,2), (4,1), (1,5), (2,4), ...)
```
...
res10: dogs.Predef.String = Streaming((1,1), (1,2), (2,1), (1,3), (3,1), (1,4), (2,3), (3,2), (4,1), (1,5), (5,1), (1,6), ...)
```
...
res11: dogs.Predef.String = Streaming((0,1), (1,1), (-1,1), (1,2), (-1,2), (2,1), (-2,1), (1,3), (-1,3), (3,1), (-3,1), (1,4), ...)
```
...
createMmix: (seed: dogs.Predef.Long)dogs.Streaming[dogs.Predef.Long]

scala> val longs: Streaming[Long] = createMmix(0x741f2d2eea7e5c70L)
longs: dogs.Streaming[dogs.Predef.Long] = Streaming(8367456312203566192, ...)

scala> longs.toString(5)
res12: dogs.Predef.String = Streaming(8367456312203566192, -7595406808669662977, -9188966057111175390, -6253267935754553271, 5593120396242050340, ...)
```
...
scala> val ints: Streaming[Int] =
     ...
     |     Streaming(n0, n1)
     |   }
ints: dogs.Streaming[dogs.Predef.Int] = Streaming(1948200238, ...)
```
...
str: (xs: dogs.Streaming[dogs.Predef.Int])dogs.Predef.String

scala> val h = pi.take(1)
h: dogs.Streaming[dogs.Predef.Int] = Streaming(3, ...)

scala> val t = pi.drop(1).take(40)
t: dogs.Streaming[dogs.Predef.Int] = Streaming(...)
